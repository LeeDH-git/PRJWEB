...
(
    ...
    CONSTRAINT PK_EMP_ACCOUNT PRIMARY KEY (EMP_NO),
    CONSTRAINT FK_EMP_ACCOUNT FOREIGN KEY (EMP_NO, EMP_NM, EMP_EMAIL, PJT_EMP_DIV_C, PJT_JG_C)
...
CREATE TABLE FL_PJT_EMP_MANAGER
(
    PJT_C         VARCHAR2(11) NOT NULL
        CONSTRAINT PK_PJT_EMP_MANAGER
            PRIMARY KEY,
    EMP_NO        VARCHAR2(7)  NOT NULL,
    PJT_EMP_DIV_C VARCHAR2(3)  NOT NULL,
    EMP_NM        VARCHAR2(10) NOT NULL,
    ...
    PJT_JG_C      VARCHAR2(3)  NOT NULL,
    PJT_ORG_C     VARCHAR2(3)  NOT NULL,
    CONSTRAINT FK_PJT_EMP_MANAGER_01
        FOREIGN KEY (EMP_NO, EMP_NM, EMP_EMAIL, PJT_EMP_DIV_C, PJT_JG_C) REFERENCES FL_EMP,
    CONSTRAINT FK_PJT_EMP_MANAGER_02
        FOREIGN KEY (PJT_C, PJT_DIV_C, PJT_ST_C, PJT_ORG_C) REFERENCES FL_PJT_CODE
);



ALTER TABLE FL_PJT_EMP_MANAGER
    ADD CONSTRAINT FK_PJT_EMP_MANAGER_02 foreign key (PJT_C, PJT_DIV_C, PJT_ST_C, PJT_ORG_C)
        references FL_PJT_CODE (PJT_C, PJT_DIV_C, PJT_ST_C, PJT_ORG_C);
