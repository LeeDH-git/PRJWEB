                            ...
                            <div class="card-body">
                                <form>
                                    <div class=form-group">
                                        ...
                                        <input class="form-control py-4" id="inputEMPNO" type="text"
                                               placeholder="사원번호 입력"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id=inputEmailAddress" type="email"
                                               aria-describedby="emailHelp" placeholder="아이디(이메일) 입력"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputPhoneNumber" type="text"
                                               placeholder="휴대전화 번호 입력"/>
                                    </div>

                                    <div class="form-group">
                                        <label class="small mb-1" for="inputEmergencyContactNumber">비상연락처</label>
                                        <input class="form-control py-4" id="inputEmergencyContactNumber" type="text"
                                               placeholder="비상연락처 입력"/>
                                    </div>

                                    <div class="form-group">
                                        <label class="small mb-1" for="inputJoinDate">입사일</label>
                                        <input class="form-control py-4" id="inputJoinDate" type="text"
                                               placeholder="입사일 입력"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="small mb-1" for="inputSkillLevel">기술등급</label>
                                            <br/>
                                            <select class="form-control py" id="inputSkillLevel"
                                        ...
                                        <div style="text-align:center;">
                                            ...
                                            <div class="card-footer text-center">
                                                <div class="small"><a href="login.jsp">Have an account? Go to login</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
